    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
            <div class="col-md-9 ftco-animate pb-5">
                ...
                <h1 class="mb-3 bread">Manage Bookings</h1>
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="card-body">
                        <table class="table table-striped table-bordered w-100 datatable">
                            ...
                            <tbody>
                                ...
                                $bookings = $database->select_all("bookings", "id", "DESC");
                                ?>
                                ...
                                <?php if ($bookings): ?>
                                    <?php foreach ($bookings as $booking): ?>
                                        ...
                                        <tr class="text-center">
                                            <td><?= $database->select_one("users", ["id" => $booking["passenger_id"]])["name"] ?></td>
                                            <td>
                                                <?php
                                            ...
                                            <td>
                                                <?php if ($booking["status"] == "pending"): ?>
                                                    <a href="javascript:void(0)" title="Approve Booking" class="confirm_cancel_booking" booking_id="<?= $booking["id"] ?>" status="CONFIRM"><i class="fa fa-thumbs-up text-primary mr-1"></i></a>
                                                    <a href="javascript:void(0)" title="Cancel Booking" class="confirm_cancel_booking" booking_id="<?= $booking["id"] ?>" status="CANCEL"><i class="fa fa-thumbs-down text-danger"></i></i></a>
                                                <?php else: ?>
